...
public class ArtsmiaDAO {
	...
	public void listObjects(Map<Integer,ArtObject> mappa) {
		...
		try {
			...
			while (res.next()) {
				...
				if(!mappa.containsKey(res.getInt("object_id"))) // if necessario per non fare creare la mappa più volte 
				{
